...
The following is your persistent memory from prior sessions. Treat it as recalled context, decisions, and ongoing state:

{{.Memory}}

## User Profile

The following describes the user's identity, preferences, and constraints. Respect these preferences in every response:
